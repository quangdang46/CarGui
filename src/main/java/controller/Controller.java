...
public class Controller {
  ...
  private ArrayList<Object> listRental;
  ...
  public Controller() {
    ...
    this.view = new Views();
    this.listRental = new ArrayList<Object>();
  }
  ...
  public void handleReadRental(String path) {
    this.listRental = model.initListRental(this.listRental, path);
  }
  ...
  //
  public ArrayList<Object> getListRental() {
    return this.listRental;
  }
  ...
  // delete car
  public void deleteCar(String path, ArrayList<Object> ids) {
    for (Object id : ids) {
      this.deleteCarInStore((String) id, path);
    }
  }
  ...
  //
  public void reservation(Customer customer, ArrayList<Object> ids, Date startDate, int timeRental, String pathListCars,
      String pathRental) {

    for (Object id : ids) {
      for (int i = 0; i < listCars.size(); i++) {
        if (listCars.get(i).toString().contains((String) id)) {
          Rental rental = new Rental(listCars.get(i), customer, startDate, timeRental);
          model.writeRental(rental, pathRental);
        }
      }
    }
    deleteCar(pathListCars, ids);
  }
